...
<article v-for="(article, key) in articles" class="post format-standard hentry" :key="key">
  ...
  <div class="entry-area">
    <div class="entry-header">
      <h2 class="entry-title"><a :href="article.path" rel="bookmark">{{article.title}}</a></h2>
      <div class="entry-meta">
        <span class="posted-on"><a :href="article.path" rel="bookmark"> <time class="entry-date" :datetime="article.pubdate">
           {{ new Date(article.pubdate).toLocaleDateString("en-US", {year:'numeric',month:'short',day:'numeric'}) }}
         </time> </a></span>
        <span class="entry-cat"><span class="cat-link"><a :href="`category/${article.category}`">{{article.category}}</a></span></span>
        <span class="entry-like"><a href=""><i class="fa fa-heart-o"></i> {{article.likes}}</a></span>
      </div>
    </div>
    <div class="entry-content">
      <p class="text-center">{{article.snip}}...
        <a href="single.html" class="more-link"><span class="moretext">Read more</span> <span class="screen-reader-text">{{article.title}}</span></a>
      </p>
    </div>
  </div>
</article>
                  ...
                  <article class="post format-standard hentry">
                    <div class="entry-featured-image">
                      <img src="~/assets/img/astrif-post-entry-02.jpg" alt="Healthy Breakfast For Cute Girl">
                    </div><!-- .entry-featured-image -->
                  ...
                  <article class="post format-standard hentry">
                    <div class="entry-featured-image">
                      <img src="~/assets/img/astrif-post-entry-03.jpg" alt="Just eat healthy food, for your better life">
                    </div><!-- .entry-featured-image -->
                  ...
                  <article class="post format-standard hentry">
                    <div class="entry-featured-image">
                      <img src="~/assets/img/astrif-post-entry-04.jpg" alt="Best beef burger in this city, I had met">
                    </div><!-- .entry-featured-image -->
                  ...
                  <article class="post format-standard hentry">
                    <div class="entry-featured-image">
                      <img src="~/assets/img/astrif-post-entry-05.jpg" alt="7 sweet hat for hangout that you should know">
                    </div><!-- .entry-featured-image -->
                  ...
                  <article class="post format-standard hentry">
                    <div class="entry-featured-image">
                      <img src="~/assets/img/astrif-post-entry-06.jpg" alt="King donut never had a queen">
                    </div><!-- .entry-featured-image -->
                  ...
                  <article class="post format-standard hentry">
                    <div class="entry-featured-image">
                      <img src="~/assets/img/astrif-post-entry-07.jpg" alt="Gelato in 'omah gelato' will punch you hard!">
                    </div><!-- .entry-featured-image -->
              ...
              <div class="col-md-4">
                <div class="site-sidebar">
                  ...
                  <section class="widget astrif_widget_popular_entries">
                    <h2 class="widget-title"><span>Popular Posts (again)</span></h2>
                    <ul>
                      <li>
 ...
 export default {
    ...
    data() {
      return {
        ...
        //  imgsrc: "./assets/img/astrif-post-entry-02.jpg",
        //  img2: "astrif-post-entry-02.jpg",
    ...
    methods: {
     formatDate: (str) => new Date(str).toLocaleDateString("en-US", {year:'numeric',month:'short',day:'numeric'})
  }
