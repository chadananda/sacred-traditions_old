        ...
        <article class="comment-body">
          <footer class="comment-meta">
            <div class="comment-author vcard">
              <g-image alt="No image" src="~/assets/img/astrif-comment-author-01.jpg" class="avatar"/>
        ...
        <ol class="children">
          <li class="comment even parent">
            <article class="comment-body">
              <footer class="comment-meta">
                <div class="comment-author vcard">
                  <g-image alt="No image" src="~/assets/img/astrif-comment-author-02.jpg" class="avatar"/>
            ...
            <ol class="children">
              <li class="comment even parent">
                <article class="comment-body">
                  <footer class="comment-meta">
                    <div class="comment-author vcard">
                      <g-image alt="No image" src="~/assets/img/astrif-comment-author-03.jpg" class="avatar"/>
                ...
                <ol class="children">
                  <li class="comment even parent">
                    <article class="comment-body">
                      <footer class="comment-meta">
                        <div class="comment-author vcard">
                          <g-image alt="No image" src="~/assets/img/astrif-comment-author-04.jpg" class="avatar"/>
